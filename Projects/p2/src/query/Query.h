...
public:
  ...
  virtual QueryResult::Ptr execute(Table &table) = 0;

  virtual std::string toString() = 0;

  virtual QueryType getQueryType() const { return QueryType::NOP; }

  const std::string &getTargetTable() const { return targetTable; }
...
public:
   ...
   * @return
   */
  bool evalCondition(const Table::Object &object, const Table &table);
  bool evalConditionNoDeleteCheck(const Table::Object &object);
